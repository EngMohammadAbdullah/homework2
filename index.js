...
homeWork.prototype.choose_operation = function (n, operation) {
    ...
    switch(operation){
        ...
        break;
        default:
            return console.log("only choose + or *");
        return n;
    }*/
    throw new Error("Not Implemneted");
...
/*homeWork.prototype.list_concatenate = function list_concatenate (list1, list2) {
function list_concatenate (list2, list1) {

var concat_list = list2.concat(list1);
return list;
}
//list2 = list_concatenate (list2, list1);
...
homeWork.prototype.convert_number_to_list = function (number) {
  var xyz = number.toString();
var convert_number_to_list = xyz.split("");
return convert_number_to_list; 
...
// manju 
    ...
    var difference = (user_number <= 13) ? 13 - user_number : (user_number - 13) * 2;
    return difference;
...
// manju 
  ...
  var first_char = givenString.charAt(0);
   var char = first_char.toUpperCase();
    var add_char_to = char + givenString + char;
    return add_char_to; 
...
//manju 
    ...
    if (givernStr.length < 3){ return false ;}
        //console.log("please enter string having at least 3 characters")}
    else var newstring = givernStr.substring(givernStr.length - 3);
    var add_last_three_char_to = newstring + givernStr + newstring;

    return add_last_three_char_to;
